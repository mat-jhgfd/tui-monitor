...
rfm.ack_wait = 1.0    # Wait 500ms for ACK
...
while True:
    ...
    msg = "M %d R %3.1f T %2.2f P %4.2f H %2.2f A %3.6f" % (counter, 0 if last_rssi is None else last_rssi, sensor_temperature, sensor_pressure, sensor_humidity, altitude)
    print("Send:", msg)
